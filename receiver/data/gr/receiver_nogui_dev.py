...
# Generated: Thu Dec 27 18:24:43 2018
##################################################
...
class receiver_nogui_dev(gr.top_block):
    ...
    def __init__(self, config_file="./default.ini", meta_dev="rtl=0", meta_samp_rate_dev=1536000):
        ...
        self.satnogs_waterfall_sink_0 = satnogs.waterfall_sink(meta_samp_rate, 0.0, 15, 2048, splitext(config_file)[0] + ".raw", 1)
        ...
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.satnogs_waterfall_sink_0, 0))    
