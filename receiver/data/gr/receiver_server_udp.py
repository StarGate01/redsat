...
# Title: REDSAT receiver server (UDP)
# Author: Christoph Honal
# Generated: Wed Dec 26 20:44:59 2018
##################################################
...
class receiver_server_udp(gr.top_block, Qt.QWidget):

    def __init__(self, meta_dev='rtl=1', meta_freq=103200000, meta_gain=40, meta_samp=128000):
        gr.top_block.__init__(self, "REDSAT receiver server (UDP)")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("REDSAT receiver server (UDP)")
        ...
        self.settings = Qt.QSettings("GNU Radio", "receiver_server_udp")
...
def main(top_block_cls=receiver_server_udp, options=None):
    if options is None:
