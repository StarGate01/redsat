...
class downlink_em(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._frequency_offset_correction_range = Range(-120000, 120000, 100, 89e2, 200)
        ...
        self.digital_mpsk_receiver_cc_0_0 = digital.mpsk_receiver_cc(2, 0, 31.41e-3, -0.01, 0.01, 0.25, 0.05, samp_rate/5/12.5e3, 0.01, 0.005)
        ...
        self.ccsds_send_nanolink_0 = ccsds.send_nanolink("https://move2radio.lrt.mw.tum.de")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_0_0_1.set_frequency_range(145.79e6, self.samp_rate*4)
        self.qtgui_sink_x_0_0_0_0.set_frequency_range(0, self.samp_rate/5)
        self.qtgui_sink_x_0_0_0.set_frequency_range(0, self.samp_rate/5)
        self.osmosdr_source_0.set_sample_rate(self.samp_rate*self.oversample)
        self.digital_mpsk_receiver_cc_0_0.set_omega(self.samp_rate/5/12.5e3)
